...
{
    public class PayPalAccountRepository : AssemblyPaymentsDotNet.Implementations.AbstractRepository,
                                         AssemblyPaymentsDotNet.Dynamic.Interfaces.IPayPalAccountRepository
    {
