...
{
    public class BatchTransactionRepository : AssemblyPaymentsDotNet.Implementations.AbstractRepository,
                                              AssemblyPaymentsDotNet.Dynamic.Interfaces.IBatchTransactionRepository
    {
