...
{
    public class ConfigurationRepository : AssemblyPaymentsDotNet.Implementations.AbstractRepository,
        AssemblyPaymentsDotNet.Dynamic.Interfaces.IConfigurationRepository
    {
