...
{
    public class DirectDebitAuthorityRepository : AssemblyPaymentsDotNet.Implementations.AbstractRepository,
                                                  AssemblyPaymentsDotNet.Dynamic.Interfaces.IDirectDebitAuthorityRepository
    {
