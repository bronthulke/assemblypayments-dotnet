...
namespace AssemblyPaymentsDotNet.Implementations
{
    public class AbstractRepository
    {
        ...
        private Hashtable Configurataion
        {
            get
            {
                return ConfigurationManager.GetSection("AssemblyPayments/Settings") as Hashtable;
            }
        }
        ...
        protected string BaseUrl
        {
            get
            {
                var baseUrl = ConfigurationManager.AppSettings["AssemblyPaymentsApiUrl"] as String;
        ...
        protected string Login
        {
            get
            {
                var login = ConfigurationManager.AppSettings["AssemblyPaymentsLogin"] as String;
        ...
        public string Password
        {
            get
            {
                var password = ConfigurationManager.AppSettings["AssemblyPaymentsPassword"] as String;
